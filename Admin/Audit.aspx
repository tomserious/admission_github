<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Audit.aspx.cs" Inherits="Admin_Audit" %>

<asp:Content ID="AdminContent" ContentPlaceHolderID="AdminContent" Runat="Server">
  <div id="ApplicationTitle">北京大学2013年全国中学生信息科学夏令营报名表</div>
  <table id="ApplicationTable" style="width: 625px; margin: 10px auto">
    <tr>
